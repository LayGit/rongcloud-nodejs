...
RongAPI.prototype = {
    ...
    userBlock:{
        ...
        query:function(callback){
            this.request('/user/block/query', null, callback);
        }
    },
    /**
     * 用户黑名单
    ...
    userBlackList:{
        ...
        add:function(userId, blackUserId, callback){
            this.request('/user/blacklist/add', {
                userId:userId,
        ...
        remove:function(userId, blackUserId, callback){
            this.request('/user/blacklist/remove', {
                userId:userId,
                blackUserId:blackUserId
            }, callback);
        },
        ...
        query:function(userId, callback){
            this.request('/user/blacklist/query', {
                userId:userId
            }, callback);
        }
    },
    ...
    message:{
        ...
        sendPrivate:function(fromUserId, toUserId, objectName, content, pushContent, pushData, callback){
            this.request('/message/private/publish', {
        ...
        sendSystem:function(fromUserId, toUserId, objectName, content, pushContent, pushData, callback){
            this.request('/message/system/publish', {
                fromUserId:fromUserId,
                toUserId:toUserId,
                objectName:objectName,
                content:content,
        ...
        sendGroup:function(fromUserId, toGroupId, objectName, content, pushContent, pushData, callback){
            this.request('/message/group/publish', {
                fromUserId:fromUserId,
                toGroupId:toGroupId,
                objectName:objectName,
                content:content,
        ...
        sendChatroom:function(fromUserId, toChatroomId, objectName, content, callback){
            this.request('/message/chatroom/publish', {
                fromUserId:fromUserId,
        ...
        sendBroadcast:function(fromUserId, objectName, content, callback){
            this.request('/message/broadcast', {
                fromUserId:fromUserId,
                objectName:objectName,
                content:content
            }, callback);
    ...
    messageHistory:{
        ...
        delete:function(date, callback){
            this.request('/message/history/delete', {
                date:date
            }, callback);
        }
    },
    ...
    group:{
        ...
        sync:function(userId, groups, callback){
            ...
            if (groups)
                for (var g in groups)
                    params[g] = groups[g];
            this.request('/group/sync', params, callback);
        },
        /**
         * 创建群组
    ...
    chatroom:{
        ...
        create:function(chatrooms, callback){
            this.request('/chatroom/create', chatrooms, callback);
        },
        /**
         * 销毁聊天室
